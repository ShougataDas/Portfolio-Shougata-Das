            ...
            <CardContent className="p-8">
              <div className="space-y-6">
                <div className="border-l-4 border-primary pl-6 animate-slideInLeft animation-delay-300">
                  <h3 className="text-xl font-semibold text-foreground mb-2">BSc in Computer Science & Engineering</h3>
                  <p className="text-lg text-muted-foreground mb-1">East Delta University</p>
                ...
                <div className="border-l-4 border-primary pl-6 animate-slideInLeft animation-delay-400">
                  <h3 className="text-xl font-semibold text-foreground mb-2">Higher Secondary Certificate (HSC)</h3>
                  <p className="text-lg text-muted-foreground mb-1">Chittagong College</p>
                ...
                <div className="border-l-4 border-primary pl-6 animate-slideInLeft animation-delay-500">
                  <h3 className="text-xl font-semibold text-foreground mb-2">Secondary School Certificate (SSC)</h3>
                  <p className="text-lg text-muted-foreground mb-1">Chittagong Govt High School</p>
                  <p className="text-muted-foreground">GPA: 5.00/5.00 | 2018</p>
                </div>
              </div>
            </CardContent>
          </Card>
